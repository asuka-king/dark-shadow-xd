        ...
        for (let user of participants) {
          ...
          try {
            ...
            let welcomeApiUrl = `https://welcome.guruapi.tech/welcome-image?username=${encodeURIComponent(
              ...
              'https://files.catbox.moe/rf2a0i.jpg'
            )}`
      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            console.error(`Error retrieving profile picture: ${error}`)
            pp = 'https://files.catbox.moe/vgswie.jpg' // Assign default image URL
            ppgp = 'https://files.catbox.moe/vgswie.jpg' // Assign default image URL
          } finally {
